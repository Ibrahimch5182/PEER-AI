    ...
    <Section crosses>
      <div className="container lg:flex">
        <div className="max-w-[35rem]">
         ...
         {/* New content outside of collabContent list */}
         <div className="mb-10">
            <h3 className="h3 mb-4 text-gradient"> {/* Add gradient text styling */}
          ...
          <Button onClick={() => document.getElementById('image-upload').scrollIntoView({ behavior: 'smooth' })}>
  Try it now
</Button>
